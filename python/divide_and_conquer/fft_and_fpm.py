"""
Referenced from https://gist.github.com/ksenobojca/dc492206f8a8c7e9c75b155b5bd7a099.
"""
...
def FPM(A, B):
    ...
    o = NthRootOfUnity(n)
    """
    Recursive calls to FFT on A and B to convert to values representation.
    """
    AT = FFT(A, o)
    BT = FFT(B, o)
    # Multiplying the values in linear time
    C = [AT[i] * BT[i] for i in range(n)]
    # Inverse FFT on the values in the C array to get the result
